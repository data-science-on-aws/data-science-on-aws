...
#    raw_datasets = load_dataset(extension, data_files=data_files)
    raw_datasets = load_dataset("amazon_us_reviews", "Digital_Software_v1_00")
    print('**** num rows before {} ****'.format(raw_datasets.num_rows))

#    raw_datasets = raw_datasets.filter(lambda review: float(review['star_rating']) == 2.0)
    print('**** num rows after {} ****'.format(raw_datasets.num_rows))
...
#        name for name in raw_datasets["train"].column_names if name != "star_rating"
#    ]
#    if (
...
#    else:
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            print('*** args.gradient_accumulation_steps {}'.format(args.gradient_accumulation_steps))
