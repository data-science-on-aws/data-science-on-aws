...
ray job submit --working-dir . --runtime-env job-pytorch-huggingface-clothing-runtime.yaml --address http://127.0.0.1:8265 -- python pytorch-huggingface-clothing.py --num_train_epochs 1 --max_length 64 --num_workers 4 --model_name_or_path distilbert-base-uncased --train_file ./data/train/part-algo-1-womens_clothing_ecommerce_reviews.csv --validation_file ./data/validation/part-algo-1-womens_clothing_ecommerce_reviews.csv
