...
ray job submit --working-dir . --runtime-env job-spark-runtime.yaml --address http://127.0.0.1:8265 -- python csv-spark.py #--max_length 64 --num_workers 20 --model_name_or_path distilbert-base-uncased --train_file ./data/train/part-algo-1-womens_clothing_ecommerce_reviews.tsv --validation_file ./data/validation/part-algo-1-womens_clothing_ecommerce_reviews.tsv
