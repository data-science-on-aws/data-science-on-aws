...
if __name__ == "__main__":
    ...
    if run_sample_predictions:
        ...
        df_test_reviews['sentiment'] = df_test_reviews['star_rating'].apply(lambda star_rating: to_sentiment(star_rating=star_rating))
        ...
        y_actual = df_test_reviews["sentiment"]
        y_actual
        ...
        plot_conf_mat(cm, classes=CLASSES, title="Confusion Matrix")
