...
def main():
    ...
    # Write out the data
    # df_train.write.option("overwrite").parquet(os.path.join("s3://", args.s3_output_bucket, args.s3_output_key_prefix, "train"))
    # df_validation.write.option("overwrite").parquet(os.path.join("s3://", args.s3_output_bucket, args.s3_output_key_prefix, "validation"))
