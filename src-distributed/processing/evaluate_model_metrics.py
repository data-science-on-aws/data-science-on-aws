...
subprocess.check_call([sys.executable, "-m", "pip", "install", "evaluate==0.4.0", "py7zr==0.20.4", "sentencepiece", "rouge_score", "peft"])
import evaluate
...
def process(args):
    ...
    print("Listing contents of input model dir before extract: {}".format(args.input_model))
    ...
    model_tar.close()
    print("Listing contents of input model dir after extract: {}".format(args.input_model))
