...
call('aws s3 cp {} {}'.format(balanced_tfidf_without_header_train_s3_uri, balanced_tfidf_without_header_train_path), shell=True)
call('aws s3 cp {} {}'.format(balanced_tfidf_without_header_validation_s3_uri, balanced_tfidf_without_header_validation_path), shell=True)
call('aws s3 cp {} {}'.format(balanced_tfidf_without_header_test_s3_uri, balanced_tfidf_without_header_test_path), shell=True)
